...
| 3 | JAI-028 | Started; `/app/` is deployed, `A-008` is active, and the sole scheduler is running | Complete five consecutive automatic runs with database evidence | No makeup, prefilled result, or early JAI-051 work |
