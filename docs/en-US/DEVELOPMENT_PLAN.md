...
| 3 | JAI-028 | Started; `/app/` is deployed, `A-008` is active, the sole scheduler is running, and automatic verification awaits `A-009` | Complete five consecutive automatic runs with database evidence | No makeup, prefilled result, or early JAI-051 work |
