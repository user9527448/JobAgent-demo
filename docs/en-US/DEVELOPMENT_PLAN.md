...
JAI-011, JAI-037, JAI-046, JAI-047, JAI-012, JAI-013, and JAI-014 have been merged and normally pushed to `develop` in order. JAI-015 is implementing XLSX position-table parsing with worksheet/cell evidence on its own branch; legacy XLS remains explicitly unsupported until representative fixtures justify an additional dependency.

After JAI-015 completes and merges, proceed to JAI-016 for attachment golden samples and batch regression evaluation, then continue through JAI-021 to reach five stable MVP sources. OCR remains deferred to JAI-B01 and must not be added early. Execute JAI-048 as a separate documentation Issue and never mix broad legacy-document migration into feature branches. Integrate remaining official and foreign-enterprise sources one by one under JAI-038–JAI-045 without bypassing login, CAPTCHA, anti-bot controls, or platform terms.
