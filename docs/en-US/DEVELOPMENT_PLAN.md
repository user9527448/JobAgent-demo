...
| 3 | JAI-028 | Started; `/app/` is deployed, the sole scheduler is running, and `A-009/jai-028` is active for five-day automatic verification | Complete five consecutive automatic runs with database evidence | No makeup, prefilled result, or early JAI-051 work |
