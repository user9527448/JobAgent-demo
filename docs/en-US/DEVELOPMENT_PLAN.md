...
JAI-011, JAI-037, JAI-046, JAI-047, and JAI-012 through JAI-019 have been merged and normally pushed to `develop` in order. JAI-020 has implemented deterministic validation reasons/severity, review and recommendation eligibility, versioned finding persistence, and an idempotent specified-document reparse command/API on its dedicated feature branch.

After JAI-020 passes its final gate and is normally pushed and merged, proceed to JAI-021 to reach five stable MVP sources and complete the three-day stability verification. Do not mix source integration or multi-day runs into JAI-020. OCR remains deferred to JAI-B01. Execute JAI-048 as a separate documentation Issue and never mix broad legacy-document migration into feature branches. Integrate remaining official and foreign-enterprise sources one by one under JAI-038–JAI-045 without bypassing login, CAPTCHA, anti-bot controls, or platform terms.
