...
JAI-011, JAI-037, JAI-046, JAI-047, JAI-012, JAI-013, JAI-014, and JAI-015 have been merged and normally pushed to `develop` in order. JAI-016 is establishing ten sanitized PDF/XLSX golden fixtures, expected intermediate results, and offline batch difference evaluation on its own branch.

After JAI-016 completes and merges, proceed to JAI-017 for deterministic field extraction and normalization, then continue through JAI-021 to reach five stable MVP sources. OCR remains deferred to JAI-B01 and must not be added early. Execute JAI-048 as a separate documentation Issue and never mix broad legacy-document migration into feature branches. Integrate remaining official and foreign-enterprise sources one by one under JAI-038–JAI-045 without bypassing login, CAPTCHA, anti-bot controls, or platform terms.
