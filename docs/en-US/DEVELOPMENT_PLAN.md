...
JAI-011, JAI-037, JAI-046, JAI-047, and JAI-012 through JAI-017 have been merged and normally pushed to `develop` in order. JAI-018 has implemented a replaceable provider, strict JSON Schema and verbatim evidence validation, Prompt versioning, timeout/retry, token/cost call records, and daily-budget queueing on its dedicated feature branch.

After JAI-018 passes its gate and is normally pushed and merged, proceed to JAI-019 for body/attachment result merging and `field_evidence` persistence. Do not add precedence, conflict resolution, or business-table writes to JAI-018. Then complete JAI-020–JAI-021 to reach five stable MVP sources. OCR remains deferred to JAI-B01. Execute JAI-048 as a separate documentation Issue and never mix broad legacy-document migration into feature branches. Integrate remaining official and foreign-enterprise sources one by one under JAI-038–JAI-045 without bypassing login, CAPTCHA, anti-bot controls, or platform terms.
