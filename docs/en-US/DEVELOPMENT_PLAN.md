...
| 3 | JAI-028 | Started; `/app/` is deployed and `A-008` is approved | Start the sole scheduler and complete five consecutive automatic runs with database evidence | No makeup, prefilled result, or early JAI-051 work |
