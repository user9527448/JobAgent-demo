...
| 3 | JAI-028 | Started; dedicated branch and `A-007` are ready | Deploy `/app/`, then complete five consecutive automatic runs with database evidence | No makeup, prefilled result, or early JAI-051 work |
