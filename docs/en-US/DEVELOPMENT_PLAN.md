...
JAI-011, JAI-037, JAI-046, JAI-047, and JAI-012 through JAI-016 have been merged and normally pushed to `develop` in order. JAI-017 has implemented and verified deterministic extraction and normalization for dates/timezones, regions, URLs, headcount, education, and recruitment categories on its dedicated feature branch while preserving raw values, normalized values, and parser evidence.

After JAI-017 is normally pushed and merged, proceed to JAI-018 for the replaceable LLM extraction service. Do not add provider, prompt, budget, or call behavior to JAI-017, and do not add JAI-019 body/attachment merging or database `field_evidence` persistence early. Then complete JAI-019–JAI-021 to reach five stable MVP sources. OCR remains deferred to JAI-B01. Execute JAI-048 as a separate documentation Issue and never mix broad legacy-document migration into feature branches. Integrate remaining official and foreign-enterprise sources one by one under JAI-038–JAI-045 without bypassing login, CAPTCHA, anti-bot controls, or platform terms.
