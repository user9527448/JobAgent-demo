...
- **依赖**：JAI-023、JAI-024
- **状态**：60 条合成拟议标注的版本对比及 9 条真实公告的端到端闭环已完成；项目负责人批准流程优先例外，等待完整门禁与 G5 合并审批。至少 50 条真实人工标注延期到 JAI-049，现有合成集不得表述为历史人工样本。
...
- **验收标准**：
  ...
  - [x] 权重调整有前后对比且更新评分版本。
  - [x] 形成 MVP 推荐局限说明。
  - [ ] 至少 50 个真实岗位的人工标注与复核（按负责人决策延期到 JAI-049，不阻塞当前流程闭环）。
