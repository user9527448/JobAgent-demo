...
The pre-replacement comparable diagnostic composite was 82.5% across NCSS (12/15), Jiangsu (6/10), and Shanghai (15/15). It was not a single all-source run and was not counted as day 1. The 2026-08-27 replacement run was interrupted by the missing 2026-08-28 observation; the later 2026-08-29/30 pair was interrupted by the missing 2026-08-31 through 2026-09-02 observations. The current sequence contains qualified day 1 on 2026-09-03 and day 2 on 2026-09-04; it requires one more qualified run on 2026-09-05. Completeness remains evidence-only: missing fields are never invented to raise the percentage.
