...
The pre-replacement comparable diagnostic composite was 82.5% across NCSS (12/15), Jiangsu (6/10), and Shanghai (15/15). It was not a single all-source run and was not counted as day 1. The final replacement run satisfies the documented no-failed-source rule and starts the sequence on 2026-08-27. Completeness remains evidence-only: missing fields are never invented to raise the percentage.
