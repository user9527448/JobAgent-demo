...
| JAI-004 Test/CI baseline | Complete, awaiting merge | `feature/jai-004-ci-test-baseline` | Unified quality gate, isolated PostgreSQL integration test, GitHub Actions |
