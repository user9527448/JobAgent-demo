...
| JAI-006 Core models/first migration | Complete, awaiting merge | `feature/jai-006-core-models-migration` | Seven core tables, constraints, relationships, UTC persistence and Alembic |
