...
| JAI-021 | 进行中，已登记合格 Day 1/Day 2 | `feature/jai-021-sources-four-five-stability` | 当前序列覆盖 2026-09-03/04；最后一个合格日为 2026-09-05 |
...
1. 于 2026-09-05 执行一次同一替换后五来源观测。不得把同日重复运行计为新一天，也不得提前关闭 JAI-021。
