...
1. 负责人在 `Asia/Shanghai` 2026-09-26 08:00 前决定 A-006：保持普通每日业务运行，或明确批准只停止 scheduler。十个缺失日期未获补跑授权，也不属于 JAI-028 试运行。
2. 稍后通过预拉取 `node:24-alpine` 完成 `M-003`；随后在不重建当前服务的前提下重跑 JAI-050 容器构建，关闭其最后一项技术验收。
3. 保持 `M-001`、`M-002` 与 `A-001/G5` 延期，直至负责人准备完成。只有 JAI-027 G5 关闭后才能先集成 JAI-027；随后普通同步、复验并集成 JAI-050。不得提前启动 JAI-028、JAI-051 或 JAI-029。
