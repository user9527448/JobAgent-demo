...
| JAI-019 | 已完成并提交；GitHub 443 阻塞推送 | `feature/jai-019-field-evidence-merging` / `a2c41fe` | 确定性正文/附件优先级、显式冲突、抽取版本与持久字段证据已验证 |
...
1. GitHub 443 恢复后普通推送已验证的 JAI-019 feature 提交，再核验 feature 三端引用一致。
