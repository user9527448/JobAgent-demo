...
| JAI-021 | 进行中，连续序列已中断 | `feature/jai-021-sources-four-five-stability` | 2026-09-03/04 两日因 2026-09-05 中国移动来源运行失败而中断；下一合格日重新计为 Day 1 |
...
1. 在下一个自然日执行一次同一替换后五来源观测。全部合格后重新计为连续 Day 1；不得把同日重复运行计为新一天，也不得提前关闭 JAI-021。
2. 形成新的连续三个合格日后，同步双语稳定性/计划/Backlog/工作日志记录，运行完整且相称的门禁，普通推送 JAI-021，并在同步 JAI-022/JAI-023 前先合并到 `develop`。
