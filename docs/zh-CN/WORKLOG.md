...
| JAI-021 | 进行中，已重新登记 Day 1 | `feature/jai-021-sources-four-five-stability` / `05f4140` | 2026-08-31 缺少运行使旧序列中断；新序列始于 2026-09-03 |
...
1. 于 2026-09-04 执行同一替换后五来源观测；仅当该日合格时，再于 2026-09-05 执行一次。不得把同日重复运行计为新一天，也不得提前关闭 JAI-021。
2. 若新 Day 3 合格，同步双语稳定性/计划/Backlog/工作日志记录，运行完整且相称的门禁，普通推送 JAI-021，并在同步 JAI-022/JAI-023 前先合并到 `develop`。
