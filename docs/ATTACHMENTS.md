...
HTML error pages, empty bodies, mismatched signatures and incompatible non-generic MIME types are rejected. Validation intentionally establishes file identity only; PDF text extraction, OCR and spreadsheet parsing belong to JAI-013 through JAI-016.
